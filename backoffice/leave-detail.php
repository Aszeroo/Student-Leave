...
<div class="card-detail">
    ...
    <form method="post">
        ...
        <div class="button-container">
            <button class="btn reject-btn" type="submit" name="status" value="rejected" onclick="return confirmReject();">ไม่อนุมัติ</button>
            <button class="btn approve-btn" type="submit" name="status" value="approved" onclick="return confirmApprove();">อนุมัติ</button>
        </div>
    </form>

    <script>
        function confirmApprove() {
            return confirm("คุณต้องการอนุมัติใบลานี้ใช่หรือไม่?");
        }

        function confirmReject() {
            return confirm("คุณต้องการปฏิเสธใบลานี้ใช่หรือไม่?");
        }
    </script>
        </div>
